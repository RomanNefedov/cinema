<template>
    <button @click="clicked()" class="relative seat">
        <svg :fill="seatColor" height="40px" width="40px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
...
const colorDisabled = "#000000"
const colorSold = "#240000"
...
function init() {
    if (props.seat == undefined) {
        disabled.value = true
        seatColor.value = colorDisabled
    } else {
        if (props.seat.sold) {
            disabled.value = true
            seatColor.value = colorSold
        }
    }
}
